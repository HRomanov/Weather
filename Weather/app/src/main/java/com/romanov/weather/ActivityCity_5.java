...
public class ActivityCity_5 extends AppCompatActivity {
    ...
    public void changeCity(String city) {
            ...
            Intent intent = new Intent(this, ActivityCity_5.class);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.city_name_1:
                        finish();
                        overridePendingTransition(0, 0);
                        Intent intent = new Intent(ActivityCity_5.this, ActivityCity_1.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        break;
                    case R.id.city_name_2:
                        finish();
                        overridePendingTransition(0, 0);
                        Intent intent3 = new Intent(ActivityCity_5.this, ActivityCity_2.class);
                    ...
                    case R.id.city_name_3:
                        finish();
                        overridePendingTransition(0, 0);
                        Intent intent1 = new Intent(ActivityCity_5.this, ActivityCity_3.class);
                    ...
                    case R.id.city_name_4:
                        finish();
                        overridePendingTransition(0, 0);
                        Intent intent2 = new Intent(ActivityCity_5.this, ActivityCity_4.class);
